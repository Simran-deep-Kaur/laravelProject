...
<div class="mb-4">
    ...
    <div>
        <input type="radio" name="gender" id="male" value="male" class="mr-1" {{isset($data) && $data->gender === 'male' ? 'checked' : '' }}>
        <label for="male" class="text-gray-700">Male</label>
    </div>
    <div>
        <input type="radio" name="gender" id="female" value="female" class="mr-1" {{ isset($data) && $data->gender === 'female' ? 'checked' : '' }}>
        <label for="female" class="text-gray-700">Female</label>
    </div>
    <div>
        <input type="radio" name="gender" id="other" value="other" class="mr-1" {{ isset($data) && $data->gender === 'other' ? 'checked' : '' }}>
